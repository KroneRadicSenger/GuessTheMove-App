...
import 'package:guess_the_move/screens/select_lives/components/select_lives_list.dart';
        ...
        builder: (context, state) => Expanded(
          child: Container(
              ...
              child: Padding(
                ...
                child: SelectLivesList(grandmaster: grandmaster, analyzedGameOriginBundle: analyzedGameOriginBundle),
              )),
        ),
      );
}
