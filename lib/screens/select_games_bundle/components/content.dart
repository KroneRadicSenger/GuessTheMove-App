...
import 'package:guess_the_move/screens/select_games_bundle/components/select_games_bundle_list.dart';
...
class Content extends StatelessWidget {
  ...
  const Content({Key? key, required this.grandmaster, required this.gameMode}) : super(key: key);
        ...
        builder: (context, state) => Expanded(
          child: Container(
            ...
            child: Padding(
              ...
              child: SelectGamesBundleList(grandmaster: grandmaster, gameMode: gameMode),
            ),
          ),
        ),
      );
