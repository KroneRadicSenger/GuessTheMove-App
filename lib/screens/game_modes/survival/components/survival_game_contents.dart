...
class SurvivalGameContents extends StatefulWidget {
  ...
  SurvivalGameContents(
      {Key? key, required this.chessBoardController, required this.ingameHeader, required this.amountLives, required this.totalMovesGuessed, required this.movesGuessedCorrect})
      : super(key: key);
...
class _TimeBattleGameContentsState extends State<SurvivalGameContents> {
                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: state is FindTheGrandmasterMovesSurvivalGameOver
