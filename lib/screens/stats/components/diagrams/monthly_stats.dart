...
class MonthlyStats extends StatefulWidget {
  final List<double> monthlyGames;

  MonthlyStats({required this.monthlyGames});

  @override
  State<StatefulWidget> createState() => MonthlyStatsState();
}
              ...
              children: [
                Expanded(
                  child: SingleChildScrollView(
                    ...
                    child: Container(
                      width: widget.monthlyGames.length / 4 * 50,
                      child: Padding(
                        padding: const EdgeInsets.only(top: 30, right: 16.0, left: 6.0),
                        child: BarChart(
                          BarChartData(
                              alignment: BarChartAlignment.spaceAround,
                              maxY: getMaxY(widget.monthlyGames),
                              ...
                              titlesData: FlTitlesData(
                                ...
                                bottomTitles: SideTitles(
                                  ...
                                  getTitles: (double value) {
                                    DateTime day = DateTime.now().subtract(Duration(days: 29 - value.toInt()));
                              ...
                              barGroups: getBars(widget.monthlyGames, state)),
                        ),
                      ),
                    ),
                  ),
