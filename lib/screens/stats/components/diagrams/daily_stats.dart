...
class DailyStats extends StatefulWidget {
  final List<double> dailyGames;

  DailyStats({required this.dailyGames});

  @override
  State<StatefulWidget> createState() => DailyStatsState();
}

class DailyStatsState extends State<DailyStats> {
              ...
              children: [
                Expanded(
                  child: SingleChildScrollView(
                    ...
                    child: Container(
                      width: widget.dailyGames.length / 4 * 50,
                      child: Padding(
                        padding: const EdgeInsets.only(top: 30, right: 16.0, left: 6.0),
                        child: BarChart(
                          BarChartData(
                              alignment: BarChartAlignment.spaceAround,
                              maxY: getMaxY(widget.dailyGames),
                              ...
                              barGroups: getBars(widget.dailyGames, state)),
                        ),
                      ),
                    ),
                  ),
