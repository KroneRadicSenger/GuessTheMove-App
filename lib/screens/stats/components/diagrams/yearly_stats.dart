...
class YearlyStats extends StatefulWidget {
  final List<double> yearlyGames;

  YearlyStats({required this.yearlyGames});

  @override
  State<StatefulWidget> createState() => YearlyStatsState();
}

class YearlyStatsState extends State<YearlyStats> {
                      ...
                      child: Padding(
                        ...
                        child: BarChart(
                          BarChartData(
                              ...
                              maxY: getMaxY(widget.yearlyGames),
                              ...
                              titlesData: FlTitlesData(
                                ...
                                bottomTitles: SideTitles(
                                    ...
                                    getTitles: (double value) {
                                      return getMonthBefore((11 - value).toInt());
                                    }),
                              ...
                              barGroups: getBars(widget.yearlyGames, state)),
                        ),
                      ),
                    ),
                  ),
  ...
  String getMonthBefore(final int monthsBefore) {
    final DateTime day = DateTime.now();
    switch ((day.month - monthsBefore) % 12) {
      case 0:
        return 'Dez';
      case 1:
        return 'Jan';
